...
#
# @example
#   include fc_image_updater::secrets
class fc_image_updater::secrets {
  ...
  file { '/tmp/git_password.encrypted':
    ...
    source => [ 'puppet:///modules/fc_image_updater/git_password.encrypted' ],
    mode => '0600'
  }
  ...
  file { '/tmp/cliff_password.encrypted':
    ...
    source => [ 'puppet:///modules/fc_image_updater/cliff_password.encrypted' ],
    mode => '0600'
  }
  ...
  file { '/tmp/cliff_ssh.tgz.encrypted':
    ...
    source => [ 'puppet:///modules/fc_image_updater/cliff_ssh.tgz.encrypted' ],
    mode => '0600'
  }
