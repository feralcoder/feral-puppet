...
#
# @example
#   include feralcoder_puppetmaster::crypt::files
class feralcoder_puppetmaster::crypt::files {
  $decrypt_secret_file='/etc/puppetlabs/code/environments/production/site-modules/feralcoder_common/files/decrypt_secret'
